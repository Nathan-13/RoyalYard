<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Property.aspx.cs" Inherits="Royal_Yard_V2._0.Property" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <br />
             <asp:Button ID="addNewProperty" class="button, btn btn-primary ," style = "margin-left:20px;" runat="server" Text="Add new Property"  OnClick="addNewProperty_Click" />
 <br />
                <br />

                <div style="width:100%; height:500px; overflow:auto">     
  <asp:ListView ID="ListView_Property" runat="server" OnItemCanceling="ListView_Property_ItemCanceling"
                    OnItemDeleting="ListView_Property_ItemDeleting" OnItemEditing="ListView_Property_ItemEditing"
                     OnItemUpdating="ListView_Property_ItemUpdating" >
                                       <LayoutTemplate>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="color:black;font-weight:bold; width:auto; "><asp:Label runat="server" ID="lbl_PropertyId" Text='<%#Eval ("PropertyId") %>' > </asp:Label>  </td>                          
                            ...
                            <td><asp:Button ID="Property_Edit" runat="server" class="button, btn btn-primary" CommandName="Edit" Text="Edit" OnClick="Property_Edit_Click"/></td>
                            <td><asp:Button ID="Property_Delete" class="button, btn btn-primary" CommandName="Delete" runat="server" Text="Delete" OnClick="Property_Delete_Click" OnClientClick="javascript:return confirm('Are you sure to delete this record?');" /></td>                          
                        </tr>
                    </ItemTemplate>
                    <EditItemTemplate>
                        <tr>
                        <td><asp:Image ID="img" ImageUrl='<%#"data:Image/png;base64," + Convert.ToBase64String((byte[])Eval("Image")) %>'  alt="W3layouts Agileits" runat="server" style="width:150px"></asp:Image><asp:FileUpload style="color:black;
            ...
            Width="300px" RepeatLayout="Flow">
                ...
                <asp:ListItem Text="Sale " Value="Sale"></asp:ListItem> 
                        ...
                        <td><asp:Button runat="server" ID="Property_Update" class="button, btn btn-primary" CommandName="Update" Text="Update" OnClick="Property_Update_Click"/>  </td>
                        <td><asp:Button runat="server" ID="Property_Delete" class="button, btn btn-primary" CommandName="Cancel" Text="Cancel" OnClick="Property_Cancel_Click"/>  </td>
                         </tr>
                    </EditItemTemplate>
